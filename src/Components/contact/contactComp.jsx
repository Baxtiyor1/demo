          ...
          <div className="contact__wrapper">
            <div className="contact__left">
              ...
              <p className="contact__form-text">
                Assalomu alaykum!Bizga xabaringizni qoldiring, har bir xabar biz
                uchun qadrli.
              </p>
              <form className="contact__form" action="" method="post">
                ...
                />
                <LinkBtn href="/contact" bgcolor="#CC1C08">
                  Yuborish
                </LinkBtn>
            ...
            <div className="contact__right">
              <iframe
                className="contact__right-map"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d748.7358539606965!2d69.218878529206!3d41.353583605400004!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38ae8d5fe50172bb%3A0x9edf9cdfb1aac46e!2sTURON%20OSHXONASI!5e0!3m2!1suz!2s!4v1655989331093!5m2!1suz!2s"
                width="880"
                height="810"
                allowFullScreen=""
                loading="lazy"
