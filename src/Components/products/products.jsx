      ...
      <div className="product">
        <div className="container">
          ...
          >
            Turon unlari restavratorlar, oshxonada o'z ijodini namoyon etishni,
            yangi va mazali ta'mlar bilan yaqinlarini quvontirishni yaxshi
            ko'radigan pazandalarimiz uchun mo'ljallangan. Xonadoningizda undan
            tayyorlanadigan tansiq taomlarni me&lsquo;yorlashtirish, pazanda uy bekasi
            ekanligingizni his qilib turishingiz uchun sizga, oliy va birinchi
            navdagi unlarning, katta va kichik oila uchun mo&rsquo;ljallangan 50
            kg gacha bo&rsquo;lgan maxsus qadoqli Turon unlarini taklif qilamiz:
          </p>
          <div className="product__wrapper">
          ...
          <div className="product__wrap">
            ...
            <p data-aos="flip-down" data-aos-duration="1000">
              Qandolatchilar, oshpazlar hamda nonvoylarga bag`ishlangan 25 kg
              og`irlikdagi paketlarimizdan nondan tortib pitsagacha,
              shirinlikdan tortib xamirli taomlargacha tayyorlashingiz mumkin. <br />
              Turon — sifatli natijalarni kafolatlaydi!
            </p>
          </div>
        </div>
